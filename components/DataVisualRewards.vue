...
<template>
  ...
  >
    ...
    <div v-if="hasHistory" class="relative h-auto w-full">
      <canvas
        ref="distributionOverMonths"
        class="[mask-image:linear-gradient(to_bottom,black,transparent)] hover:[mask-image:none]"
      ></canvas>
    </div>
    ...
    <Badge v-else class="sm:px-6 mb-24 sm:mr-16 sm:ml-8 w-full sm:w-fit">
      <div class="flex flex-col gap-2 py-8 px-6">
        ...
        <p class="dark:text-gray-200">
          If you recently set up your relay it might take some time before you
          can claim rewards.
        </p>
        <p class="dark:text-gray-200">
          You can learn more about
          <a
            href="https://relayseries.ator.io/welcome/welcome-to-ator-relay-education"
            target="_blank"
            rel="noopener noreferrer"
            class="dark:text-teal-400 text-gray-800 hover:text-teal-500"
            >setting up your own relays here.</a
          >
        </p>
      </div>
    </Badge>
