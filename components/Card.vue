...
<template>
  <div v-intersection-observer="[onInView, { threshold: 0.75 }]" :class="[isVisible ? 'opacity-100' : 'opacity-70']"
    ...
    <div :class="[
      ...
      <!-- Padding -->
      <div :class="[noPadding ? 'p-0' : 'py-4 px-4 ']" class="flex-col flex h-full">
        <slot></slot>
      </div>
      <div
